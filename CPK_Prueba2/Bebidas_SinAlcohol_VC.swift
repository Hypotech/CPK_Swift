...
class Bebidas_SinAlcohol_VC:MenusCPK{
    ...
    var Myfondo: UIImage = UIImage(named: "sinalcohol_foto.jpg")!
    ...
    override func viewDidLoad() {
        ...
        super.nombreJSON = "no_alcohol"
        super.NombreFondo = "BEBIDAS SIN ALCOHOL"
        ////////////////////////////////////
    ...
    @IBAction func gestoManejador(send: UIGestureRecognizer){
        ...
        if let swipeGesture = send as? UISwipeGestureRecognizer { //casting si es un GestureSwipe
            ...
            case UISwipeGestureRecognizerDirection.Left:
                self.performSegueWithIdentifier("Segue_Menu_Refrescos", sender: self)
            default: break
            }
        }
    }
