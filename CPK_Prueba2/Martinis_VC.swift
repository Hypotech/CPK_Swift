...
class Martinis_VC:MenusCPK{
    ...
    var Myfondo: UIImage = UIImage(named: "martinis_foto.jpg")!
    ...
    override func viewDidLoad() {
        ...
        super.nombreJSON = "martini"
        super.NombreFondo = "MARTINIS"
        ////////////////////////////////////
    ...
    @IBAction func gestoManejador(send: UIGestureRecognizer){
        ...
        if let swipeGesture = send as? UISwipeGestureRecognizer { //casting si es un GestureSwipe
            ...
            case UISwipeGestureRecognizerDirection.Right:
                self.performSegueWithIdentifier("Segue_Vinos_Return", sender: self)
            case UISwipeGestureRecognizerDirection.Left:
                self.performSegueWithIdentifier("Segue_Mojitos", sender: self)
            default: break
            }
        }
    }
