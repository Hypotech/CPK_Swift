...
class Cocteles_SinAlcohol_VC: MenusCPK {
    ...
    var Myfondo: UIImage = UIImage(named: "coctelsnalcohol_foto.jpg")!
    ...
    override func viewDidLoad() {
        ...
        super.nombreJSON = "coctel_s_alcohol"
        super.NombreFondo = "COCTELES CPK"
        ////////////////////////////////////
    ...
    @IBAction func gestoManejador(send: UIGestureRecognizer){
        ...
        if let swipeGesture = send as? UISwipeGestureRecognizer { //casting si es un GestureSwipe
            ...
            case UISwipeGestureRecognizerDirection.Right:
                self.performSegueWithIdentifier("Segue_Menu_Refrescos_Return", sender: self)
