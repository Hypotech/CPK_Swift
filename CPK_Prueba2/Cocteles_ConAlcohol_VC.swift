...
class Cocteles_ConAlcohol_VC:MenusCPK{
    ...
    var Myfondo: UIImage = UIImage(named: "coctelalcohol_foto.jpg")!
    ...
    override func viewDidLoad() {
        ...
        super.nombreJSON = "coctel"
        super.NombreFondo = "COCTELES"
        ////////////////////////////////////
    ...
    @IBAction func gestoManejador(send: UIGestureRecognizer){
        ...
        if let swipeGesture = send as? UISwipeGestureRecognizer { //casting si es un GestureSwipe
            ...
            case UISwipeGestureRecognizerDirection.Right:
                self.performSegueWithIdentifier("Segue_CoctelesSinAlcohol_Return", sender: self)
            case UISwipeGestureRecognizerDirection.Left:
                self.performSegueWithIdentifier("Segue_Cervezas", sender: self)
            default: break
            }
        }
    }
