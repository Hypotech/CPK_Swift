...
class Sopas_VC: MenusCPK {
    ...
    var Myfondo: UIImage = UIImage(named: "sopas_foto.jpg")!
    ...
    override func viewDidLoad() {
        ...
        super.nombreJSON = "sopa"
        super.NombreFondo = "ESTILO CEDONA"
        ////////////////////////////////////
    ...
    @IBAction func gestoManejador(send: UIGestureRecognizer){
        ...
        if let swipeGesture = send as? UISwipeGestureRecognizer { //casting si es un GestureSwipe
            ...
            case UISwipeGestureRecognizerDirection.Right:
                self.performSegueWithIdentifier("Segue_Ensaladas_Return", sender: self)
