...
class Mojitos_VC:MenusCPK{
    ...
    var Myfondo: UIImage = UIImage(named: "mojitos_foto.jpg")!
    ...
    override func viewDidLoad() {
        ...
        super.nombreJSON = "mojito"
        super.NombreFondo = "MOJITOS"
        ////////////////////////////////////
    ...
    @IBAction func gestoManejador(send: UIGestureRecognizer){
        ...
        if let swipeGesture = send as? UISwipeGestureRecognizer { //casting si es un GestureSwipe
            ...
            case UISwipeGestureRecognizerDirection.Right:
                self.performSegueWithIdentifier("Segue_Martinis_Return", sender: self)
            case UISwipeGestureRecognizerDirection.Left:
                self.performSegueWithIdentifier("Segue_Sangrias", sender: self)
            default: break
            }
        }
    }
